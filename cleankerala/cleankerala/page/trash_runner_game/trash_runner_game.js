    ...
    try {
        ...
        const logoBar = `
            ...
            <style>
                ...
                /* ✅ Game Button Styles */
                #btn-recycle, #btn-organic, #btn-trash {
        ...
        `;
        $(page.parent).prepend(logoBar);

        // ✅ Game HTML
        const gameHTML = `
            <div style="text-align:center; margin-bottom:10px; font-size:22px; font-weight:bold; color:#00796b; margin-top:50px;">
                🗑️ ട്രാഷ് സോർട്ടർ <br> ശരിയായ ബിൻ തിരഞ്ഞെടുക്കുക! ♻️
            </div>
            <div id="item-container" style="font-size:60px; text-align:center; margin:30px 0;">🍌</div>
            <div style="text-align:center;">
                <button id="btn-recycle">♻️ റീസൈക്കിൾ</button>
                <button id="btn-organic">🍂 ഓർഗാനിക്</button>
                <button id="btn-trash">🗑️ മാലിന്യം</button>
            </div>
            <div id="score" style="text-align:center; font-size:18px; color:#004d40; margin-top:20px;">സ്കോർ: 0 | ജീവൻ: 3</div>
            <div id="game-over" style="text-align:center; font-size:24px; color:red; margin-top:20px; display:none;"></div>
            <div id="restart-wrapper" style="text-align:center; margin-top:20px; display:none;">
